        ...
        >
          ...
          <a href="/JobListing">
            <div className="pb-[20px] flex items-center -ml-5 hover:text-[#00AFEE] ">
              ...
              <h1 className={` ${!sidebarOpen && 'hidden'} `}>Job Listing</h1>
            </div>
          </a>
          <a href="/JobStatsTable">
            <div className="pb-[20px] flex items-center -ml-5 hover:text-[#00AFEE]  ">
              <div className={`${!open && '-ml-4'}`}>
                <IoStatsChartSharp className="text-3xl w-auto mr-4" />
              </div>
              <h1 className={` ${!sidebarOpen && 'hidden'} `}>Jobs Stat</h1>
            </div>
          </a>
          <a href="">
            <div className="pb-[20px] flex items-center -ml-5 hover:text-[#00AFEE] ">
